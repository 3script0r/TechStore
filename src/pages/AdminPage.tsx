  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'wishes' && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-6">Solicitudes de Productos</h2>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="font-semibold text-gray-900">{wish.user_name}</h3>
                        <span className="text-sm text-gray-500">{wish.user_email}</span>
                      </div>
                      <p className="text-gray-700 mb-2">{wish.product_description}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="is_new" className="ml-2 text-sm font-medium text-gray-700">
              Marcar como nuevo (aparecerá en el carrusel)
            </label>
          </div>
